...
//   let firstPokemon = await axios.get(`https://pokeapi.co/api/v2/pokemon/${rand1}`)
//   let secondPokemon = await axios.get(`https://pokeapi.co/api/v2/pokemon/${rand2}`)
//   let thirdPokemon = await axios.get(`https://pokeapi.co/api/v2/pokemon/${rand3}`)
